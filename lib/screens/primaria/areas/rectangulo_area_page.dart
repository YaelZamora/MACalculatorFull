...
class RectanguloArea extends StatefulWidget {
  const RectanguloArea({Key? key}) : super(key: key);

  @override
  State<RectanguloArea> createState() => _RectanguloAreaState();
}

class _RectanguloAreaState extends State<RectanguloArea> {
